...
> is a second powered inverted FAIL (upstream-verbatim nDCG@4 0.284 vs 0.133,
> Δ=−0.150 [−0.165, −0.136], MDE 0.018), for a **distinct** reason from X: not
> counter-congruent recall but **affect-orthogonal, content-determined gold** (45.2% of
> queries affectively neutral; appraisal still faithful, D1 AUC=0.950). Because X2's corpus
> is affect-discriminative (D2=63.0%) yet still fails, the operative boundary is sharper
