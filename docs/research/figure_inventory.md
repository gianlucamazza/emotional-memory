...
| `research_multilingual` | grouped\_bar\_with\_ci | `results.v2_{it,es}.{sbert,me5}.json` + `results.v2_fr.me5.json` | `retrieval_affect_aware`, `cross_domain_affect_replication` | README.md, `09_current_evidence.md` |
