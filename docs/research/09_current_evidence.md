...
- **Affect-free dataset (`noAF`)** — events carry **no preset valence/arousal
  fields** and queries no `state` field. The _content_ is still affect-rich; the
  affect signal must be inferred end-to-end by the appraisal engine. This is a
  property of the _annotation_, not of the content (`realistic_recall_v3_noAF`,
  `v4_noAF`).
- **Affect-free query** — a query whose target is **determinable from semantics
  ...
  of the _query_, and it is the regime where naive cosine is hard to beat
...
| `retrieval_affect_aware`             | Retrieval behavior         | Controlled evidence          | `2_controlled_retrieval` | Retrieval is affect-aware, not semantic-only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 127 fidelity cases validate affect-aware ranking logic. The controlled quadrant benchmark (SBERT) ties AFT and naive_cosine at recall@5 = 0.80 (ceiling effect, N = 20 items) while clearly beating recency (Δ = −0.55, p < 0.001). The realistic replay v2 benchmark shows AFT top1 = 0.53 vs naive_cosine = 0.33 with SBERT (N = 200; Δ=+0.205 [0.150,0.265], p_bootstrap<0.001) and 0.50 vs 0.34 with e5-small-v2 (Δ=+0.155 [0.090,0.225], p_bootstrap<0.001). Hd2 confirms architecture-level advantage on v2 and Italian cross-language; S3 shows no single layer is isolatably responsible. Addendum M FR PASS (2026-05-16): French slice (me5, N=120, 2-session) AFT top1=0.31 vs naive_cosine=0.12, Δ=+0.18 [0.11, 0.26], p<0.0001, Hedges g=0.424 — cross-language signal confirmed.                                      | General downstream superiority over production memory systems. IT/ES cross-language at me5 N=120 remains open (Hd2 Branch C FAIL).                                                                                                                                                              | Expand external and realistic retrieval evaluations.                                                                                     |
| `theory_faithful_operationalization` | Theory fidelity            | Strong intra-theory evidence | `1_theory_fidelity`      | The implementation is faithful to the theories it operationalizes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 127 fidelity cases across 20 phenomena validate expected intra-theory behavior. S3 ablation (N=200, SBERT and e5-small-v2) covers all 7 AFT mechanisms; the 8-variant ablation shows system-level advantage but no isolatable single-layer attribution. Hi3 PASS (Addendum I closure, 2026-05-06, N=500): cross-embedder amplification on `semantic_confound` confirmed (Δ=+0.090, d=0.257, p_adj=0.0234); Hi3_recency PASS; Hi3_arc FAIL.                                                                                                                                                                                                                                                                                                                                                                                         | Ecological correspondence to human emotional memory. LLM-appraisal dual-path advantage on affect-free data is falsified (Addendum G/P — see `appraisal_llm_real_dual_path`). Hi2 mechanism for amplification not localised at link-count instrumentation level.                                 | Human and behavioral validation.                                                                                                         |
| `appraisal_directionally_useful`     | Appraisal quality          | Early controlled evidence    | `3_appraisal_quality`    | Appraisal is directionally useful.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | The appraisal-quality benchmark provides early controlled evidence on natural-language inputs. Human-gold construct validity now measured (Addendum S, EmoBank N=300): LLM valence r=0.70 vs human labels — see `appraisal_human_validated`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Calibration across models, domains, and languages.                                                                                                                                                                                                                                              | Appraisal robustness study across models, domains, and languages.                                                                        |
| `appraisal_human_validated`          | Appraisal quality          | Early controlled evidence    | `3_appraisal_quality`    | Against human-annotated affect (EmoBank, N=300), LLM appraisal valence is human-validated (Pearson r=0.70 [0.66, 0.75]); arousal (r=0.28 [0.17, 0.37]) and dominance (r=0.33 [0.22, 0.43]) are weakly-to-moderately positive (CIs exclude 0). A persistent positive valence bias (+0.15) remains. The rule-based KeywordAppraisalEngine is not human-validated (valence r=0.07).                                                                                                                                                                                                                                                                                                                                                                       | Pre-registered Addendum S executed 2026-06-26 on EmoBank (human VAD, N=300, CC-BY-SA 4.0). LLM engine: valence r=0.703 [0.655, 0.746] bias +0.152; arousal r=0.276 [0.172, 0.373]; dominance r=0.333 [0.224, 0.432]. Keyword engine not human-validated (valence r=0.070).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Strong validity on arousal/dominance; correction of the +0.15 valence bias in the production path; non-English corpora.                                                                                                                                                                         | Wire Addendum O recalibration into the appraisal path and re-measure; extend to a second human corpus.                                   |
...
| `downstream_value`                   | Downstream tasks           | Early controlled evidence    | `4_realistic_tasks`      | In the affect-discriminative regime (oracle affect + query-time state injection), AFT's retrieval-ranking advantage converts to higher LLM-judged answer quality: on realistic_recall_v2 (N=200, sbert-bge, gpt-5-mini judge) AFT judge-accuracy 0.595 vs cosine 0.440 (Δ=+0.155 [0.095, 0.220], p<0.001), token-F1 Δ=+0.152. No downstream benefit is shown in the naturalistic, automatic-appraisal regime (see locomo_external_qa_negative).                                                                                                                                                                                                                                                                                                        | Pre-registered Addendum R (Hr1/Hr2) executed 2026-06-26. encode→retrieve→generate→judge on realistic_recall_v2 (200 queries), identical generator + judge for both systems; only retrieval differs. Hr1 judge_correct AFT 0.595 vs cosine 0.440, Δ=+0.155 [+0.095, +0.220], p<0.001, Holm<0.001, McNemar<0.001 — PASS. Hr2 token-F1 Δ=+0.152 [+0.100, +0.205] — PASS. Ranking ref top1 Δ=+0.205 matches Hd2; the +0.205 ranking edge converts ~1:1 to a +0.155 answer-quality edge. Positive across all 5 challenge types.                                                                                                                                                                                                                                                                                                         | Downstream value in the oracle-free / automatic-appraisal regime (LoCoMo shows AFT loses there). Bounded by the A2 oracle-affect + state-injection boundary.                                                                                                                                    | A downstream task that is both affect-discriminative AND oracle-free (automatic appraisal supplying the affect).                         |
...
| `Hi3_arc`                            | Retrieval behavior         | Falsified                    | `2_controlled_retrieval` | Hi3_arc FAIL: no significant amplification on affective_arc queries (Δ=+0.010 [-0.020,0.050], d=0.058, Holm-adj p=0.3795, N=500). The embedder gap does not extend to affective_arc at this sample size.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Hi3_arc secondary FAIL (Addendum I closure, 2026-05-06): Δ=0.010, p_adj=0.3795, d=0.058. Embedder amplification scoped to semantic_confound and recency_confound.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Whether larger N or different dataset would show signal.                                                                                                                                                                                                                                        | No active follow-up; Hi3_arc FAIL scopes the amplification claim.                                                                        |
| `cross_domain_affect_replication`    | External benchmarks        | Controlled evidence          | `4_realistic_tasks`      | Hk1 FAIL (Branch B, 2026-05-07): DailyDialog ecological replication — AFT does not outperform naive cosine on naturalistic short-turn dialogue (N=120 personas, 396 queries, multilingual-e5-small; Δ=-0.008, p_holm=1.000). Addendum M FR PASS (Branch A, 2026-05-16): native French scenarios, 2-session realistic replay (N=120, me5); AFT top1=0.31 vs naive_cosine=0.12, Δ=+0.18 [0.11, 0.26], p<0.0001, Hedges g=0.424. Addendum X FAIL (2026-07-02): first third-party retrieval-native corpus (MADial-Bench EN, NAACL 2025, N=160, oracle-free) — aft_query_appraised significantly below naive cosine (nDCG@5 0.221 vs 0.304). Addendum X2 FAIL (2026-07-07): second third-party corpus (ES-MemEval/EvoEmo, WWW 2026, N=1,133, oracle-free) — aft_query_appraised significantly below naive cosine (upstream-verbatim nDCG@4 0.133 vs 0.284). Addendum Z FAIL (2026-07-14): held-out linear learning-to-rank does not beat cosine on any third-party corpus. | Hk1 pre-registered and executed 2026-05-07. DailyDialog: AFT top1=0.212 vs naive_cosine=0.220 (Δ=-0.008, p_holm=1.000). Branch B confirmed. Addendum M FR (2026-05-16, me5, N=120): AFT top1=0.31 vs cosine 0.12, Δ=+0.18, Branch A PASS. Addendum X (MADial-Bench): Hx1 FAIL inverted. Addendum X2 (ES-MemEval): Hx2 FAIL inverted. Addendum Z (learned profile): Hz1 FAIL 0/3 third-party corpora.                                                                                                                                                                                                                                                                                                                                                                                                                       | Cross-domain replication on affect-rich naturalistic corpus. Cross-language replication in non-Romance languages. IT/ES cross-language replication in 2-session realistic replay format.                                                                                                        | Retry targeted affective_trajectory sub-claim at N≥120 on naturalistic corpus with >30% affect-bearing turns.                            |
| `query_affect_gate`                  | Retrieval mechanism        | Controlled evidence          | `4_realistic_tasks`      | Addendum Y (Branch A, 2026-07-07): a query-affect-conditioned gate — route the query to pure cosine when the appraised query is affectively neutral (|valence|<0.2), else to the retrieve-time affect-conditioned arm — is a validated partial safe wrapper. Hg1 (recover, ES-MemEval) and Hg2 (preserve, realistic_recall_v2) both PASS (Holm m=2, gated>aft +0.076 and gated>cosine +0.095).                                                                                                                                                                                                                                                                                                                                                                      | Addendum Y executed 2026-07-07 (4 corpora, tau=0.2 primary, Holm m=2). Hg1 (ES-MemEval) gated>aft delta=+0.076 p_holm=0.0000; Hg2 (realistic_recall_v2) gated>cosine delta=+0.095 p_holm=0.0000. Per-corpus recovery tracks the neutral-query fraction: ES-MemEval 45.5% neutral → 50% recovered.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Gains beyond safe-wrapper (the gate cannot beat cosine on affect-orthogonal/counter-congruent corpora).                                                                                                                       | None scheduled. `retrieve_query_gated()` shipped in v0.17.0; remaining limitation is the X/X2 gold-relation boundary.                                                                       |
...
2. ~~**Expand the realistic replay benchmark**~~
   _Completed (v2.0): 50 scenarios / 200 queries; decisive advantage on SBERT
   and e5-small-v2 (both p_bootstrap<0.001). G4 + G5 addressed._
...
4. ~~**Run LoCoMo end-to-end for external benchmark validation**~~
   _Completed 2026-04-27 (Gate 1 FAIL): `benchmarks/locomo/results.json` committed.
   ...
   in `claim_validation_matrix.json`._
...
The resonance layer shows an unexpected _positive_ effect with e5 (Hb FAIL,
...
strong AFT advantage: Δ=+0.18 [0.11, 0.26], p<0.0001, Hedges g=0.424. This is a _different runner
and dataset format_ from the Hd2 appraisal_confound runs above (single-session). Cross-language
...
Hk1 FAIL (Branch B, 2026-05-07): DailyDialog ecological replication — AFT does not outperform naive cosine on naturalistic short-turn dialogue (N=120 personas, 396 queries, multilingual-e5-small; Δ=-0.008, p_holm=1.000). Addendum M FR PASS (Branch A, 2026-05-16): native French scenarios, 2-session realistic replay (N=120, me5); AFT top1=0.31 vs naive_cosine=0.12, Δ=+0.18 [0.11, 0.26], p<0.0001, Hedges g=0.424. Addendum X FAIL (2026-07-02): first third-party retrieval-native corpus (MADial-Bench EN, NAACL 2025, N=160, oracle-free) — aft_query_appraised significantly below naive cosine (nDCG@5 0.221 vs 0.304, Δ=-0.083 [-0.123, -0.043], p_one=0.9998) despite faithful appraisal (D1 AUC=0.996) and an affect-discriminative corpus (D2=76.9%); construct mismatch — the benchmark rewards counter-congruent supportive recall (emotion regulation), the opposite of AFT's mood-congruence prior. Addendum X2 FAIL (2026-07-07): second third-party corpus (ES-MemEval/EvoEmo, WWW 2026, N=1,133 in-family queries, oracle-free) — aft_query_appraised significantly below naive cosine (upstream-verbatim nDCG@4 0.133 vs 0.284, Δ=-0.150 [-0.165, -0.136], p_one=1.0000, powered: MDE 0.018) despite faithful appraisal (D1 AUC=0.950) and an affect-discriminative corpus (D2=63.0%); failure mode distinct from X — the gold is affect-orthogonal (content-determined; 45.2% of queries affectively neutral, corr(query, gold valence)=+0.25, only 13.1% opposite-sign), not counter-congruent; positive retrieval evidence remains confined to author-crafted corpora. Addendum Z FAIL (2026-07-14): held-out linear learning-to-rank over the 6 AFT retrieval signals (k=5 cross-fitting, Holm m=3) does not beat cosine on any third-party corpus (MADial Δ=+0.015 p_holm=0.314; ES-MemEval Δ=−0.015 p_holm=0.9997; DailyDialog Δ=+0.008 p_holm=0.811) while preserving/amplifying curated on-regime advantage (learned top1=0.425 vs fixed 0.240, Hz2 PASS); boundary hardened from fixed-weight failure to no held-out learned linear affect profile generalizes on third-party gold.
...
**Addendum T2A (2026-06-27) — query appraisal does not rescue it.** Re-running the same
personas with an `aft_query_appraised` arm (direct-VAD query appraisal at retrieve-time via
the public `query_affect` API; encode path unchanged) still FAILs: aft_query_appraised
top1=0.212 vs cosine 0.220 (Δ=−0.008 [−0.056, +0.040], p_holm=1.000, 0/3 directional types),
only +0.010 (ns) over stale-state AFT. The query appraisal is faithful (diagnostic valence
r=0.69, arousal r=0.74), so this is a regime limit, not an appraisal-quality failure: the
production-reachable recovery shown in Addendum T (curated `realistic_recall_v2`) is **bounded
to the affect-discriminative regime** (Addendum U) and does not extend to naturalistic dialogue.
Result files: `benchmarks/dailydialog/t2a_results.{json,md,protocol.json}`. Closure:
`benchmarks/preregistration_addendum_t2a_naturalistic_query_appraisal_closure.md`.

### Hg1 Diagnosis — Appraisal Calibration (Addendum N, 2026-05-30)

The Hg1 null (LLM appraisal does not beat naive cosine on affect-free data) was
diagnosed, not just observed. A calibration study (gpt-5-mini, N=150, seed 42)
shows the appraisal layer is **mis-calibrated, not blind**: valence tracks the
gold signal strongly (Pearson r ≈ 0.81–0.88) but carries a systematic positive
bias (+0.169). A pre-registered prompt-only calibration attempt **FAILED** its
criteria (Hn1 FAIL, Hn2 FAIL) — yet it nearly eliminated the valence bias
(+0.169 → +0.044, below the 0.10 threshold) while leaving arousal untouched
(−0.115 → −0.118) and regressing one gold case (15/15 → 14/15).
...
SEC→arousal _mapping_ rather than prompt wording. Closure:
...
confirmatory PASS is **Hq2** (+0.080, p*holm=0.0009): the front-router recovers the entire
always-on penalty — the gated arms score \_exactly* cosine on the affect-free half (Hq5
Δ=0.000). Gating is a safe wrapper, not an advantage. Gate classifier: LLM gate accuracy
0.844 (affective recall 0.69); the oracle gate scores _worse_ overall than the imperfect
...
**Claim `query_affect_gate`.** Addendum Y (Branch A, 2026-07-07): a query-affect-conditioned gate — route the query to pure cosine when the appraised query is affectively neutral (|valence|<0.2), else to the retrieve-time affect-conditioned arm — is a validated partial safe wrapper. Hg1 (recover, ES-MemEval) and Hg2 (preserve, realistic_recall_v2) both PASS (Holm m=2, gated>aft +0.076 and gated>cosine +0.095). The gate recovers exactly the neutral-query component of the off-regime penalty (~50% on ES-MemEval's 45.5%-neutral queries; 0% on MADial's 0%-neutral queries) and preserves the full on-regime gain; it does not fix the X/X2 boundary (affect-carrying-but-misaligned queries stay un-gateable). Shipped as EmotionalMemory.retrieve_query_gated() / AsyncEmotionalMemory.retrieve_query_gated() in v0.17.0 (EmotionalMemoryConfig.query_affect_gate_tau, default 0.2).

### Addendum Z — Held-out learned retrieval profile (Branch B)

**`cross_domain_affect_replication` bound hardened.** Addendum Z (Branch B, 2026-07-14): a held-out linear learning-to-rank profile over the 6 AFT retrieval signals (k=5 cross-fitting, Holm m=3) does **not** beat cosine on any third-party corpus — MADial Δ=+0.015 p_holm=0.314, ES-MemEval Δ=−0.015 p_holm=0.9997, DailyDialog Δ=+0.008 p_holm=0.811 — while preserving and amplifying the curated on-regime advantage (learned top1=0.425 vs fixed 0.240, Hz2 Δ_vs_fixed=+0.185). Learned weights recover negative s2 on MADial/ES-MemEval (counter-congruent direction) but do not close the cosine gap. The operative boundary upgrades from fixed-weight misspecification to: no held-out learned linear affect profile generalizes on third-party gold. No new positive claim; `fit_retrieval_weights()` src API remains a Branch-A-only follow-up.
