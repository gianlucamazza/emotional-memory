...
Park, J.S., O'Brien, J.C., Cai, C.J., Morris, M.R., Liang, P., Bernstein, M.S. (2023). _UIST 2023 / arXiv:2304.03442_.

Twenty-five LLM-powered agents inhabit a sandbox world. Each agent maintains a _memory stream_ of natural-language observations retrieved by a composite score of recency (exponential decay), importance (LLM self-rating 1–10), and semantic relevance (cosine similarity). Higher-level _reflections_ are synthesized periodically. This is the closest structural predecessor to AFT: AFT replaces the scalar importance score with a six-signal retrieval vector (valence, arousal, mood congruence, momentum alignment, ACT-R decay, resonance) and adds five affective layers absent here. Park et al. provide no mechanism for reconsolidation or Hebbian link strengthening.

**[P2] MemGPT: Towards LLMs as Operating Systems**
Packer, C., Fang, V., Patil, S.G., Zhang, K., Wooders, S., Gonzalez, J.E. (2023). _arXiv:2310.08560_.
...
Zhong, W., Guo, L., Gao, Q., Wang, Y. (2023). _AAAI 2024 / arXiv:2305.10250_.
...
Zhang, Z., Bo, X., Ma, C., Li, R., Chen, X., Dai, Q., Zhu, J., Dong, Z. et al. (2024). _arXiv:2404.13501_.
...
Xu, W., Liang, Z., Mei, K., Gao, H., Tan, J., Zhang, Y. (2025). _arXiv:2502.12110_.
...
Chhikara, P. et al. (2025). _arXiv:2504.19413_.
...
Zeng, R., Fang, J., Liu, S., Meng, Z. (2024). _arXiv:2412.15266_.
...
He, Z., Lin, W., Zheng, H., Zhang, F., Jones, M., Aitchison, L., Xu, X., Liu, M. et al. (2024). _arXiv:2411.00489_.
...
Fountas, Z., Benfeghoul, M.A., Oomerjee, A., Christopoulou, F., Lampouras, G., Bou-Ammar, H., Wang, J. (2024). _arXiv:2407.09450_.
...
Jiang, H., Chen, J., Pan, Y., Chen, L., You, W., Zhou, Y., Zhang, R., Zhao, L. et al. (2026). _arXiv:2601.02744_.
...
Mody, P., Panchal, M., Kar, R., Bhowmick, K., Karani, R. (2026). _arXiv:2603.15642_.
...
Huang, L., Lan, H., Sun, Z., Shi, C., Bai, T. (2024). _arXiv:2410.23041_.
...
Sumida, R., Inoue, K., Kawahara, T. (2024). _arXiv:2409.12524 / Dialogue & Discourse_.
...
Authors not disclosed in search results (2025). _arXiv:2510.27418_.
...
Wang, M., Wang, P., Wu, L., Yang, X., Wang, D., Feng, S., Chen, Y., Wang, B. et al. (2025). _arXiv:2506.00551_.
...
Liang, X., He, Y., Xia, Y., Song, X., Wang, J., Tao, M., Sun, L., Yuan, X. et al. (2024). _arXiv:2409.00872_.
...
Croissant, M., Frister, M., Schofield, G., McCall, C. (2024). _PLOS One / arXiv:2309.05076_.
...
Li, Y., Sun, Q., Schlicher, M., Lim, Y.W., Schuller, B.W. (2025). _arXiv:2508.10286_.
...
Martínez, G., Molero, J.D., González, S., Conde, J., Brysbaert, M., Reviriego, P. (2024). _arXiv:2408.16012_.
...
Liu, Z., Yang, K., Zhang, T., Xie, Q., Yu, Z., Ananiadou, S. (2024). _arXiv:2401.08508_.
...
Nazar, N., Asgari, E. (2025). _arXiv:2508.06196_.
...
**[P26] LLMs Capture Emotion Labels, Not Emotion Uncertainty: Distributional Analysis and Calibration of Human-LLM Judgment Gaps**
Inoshita, K., Zhou, X., Kawai, A., Yada, K. (2026). _arXiv:2604.27345_.

Benchmarks four zero-shot LLMs plus a fine-tuned RoBERTa baseline on EmoBank VAD rating: valence r = 0.49–0.67 and arousal r = 0.19–0.34 across models, with systematic divergence from human rating distributions. Also documents that low MAE can coexist with low correlation when predictions compress toward the mean (their lowest-MAE model is also their lowest-r one). Directly comparable to Addenda S/V/W: AFT's schema-constrained direct-VAD protocol (valence r = 0.79, arousal r = 0.58 on the same corpus) exceeds these zero-shot ranges, and the MAE-vs-r trade-off they document independently motivates Addendum W's affine arousal calibration.

**[P27] Aware Yet Biased: Investigating Emotional Reasoning and Appraisal Bias in Large Language Models**
Tak, A.N., Gratch, J., Scherer, K.R. (2025). _IEEE Transactions on Affective Computing_.

GPT-4 predicts emotions and appraisals in a largely language-independent way, but struggles with shame/fear/irritation and fails on appraisal dimensions related to control and power. LLMs appraise situations as if they had a high-agreeableness, low-power personality profile. This independently explains two AFT observations: the persistent +0.15 positive valence bias of `LLMAppraisalEngine` (Addendum S) and the weakness of the SEC control/power projection behind the dominance axis (Addendum V).

**[P28] The Personalization Trap: How User Memory Alters Emotional Reasoning in LLMs**
Fang, X., Xu, W., Zhang, Y., Eckman, S., Nickleach, S., Reddy, C.K. (2025). _arXiv:2510.09905_.

Across 15 models, identical scenarios paired with different user profiles produce systematically divergent emotional interpretations, with advantaged demographic profiles receiving more accurate readings. A caution directly relevant to any affect-aware memory system, AFT included: the persistent memory itself can shift appraisal along demographic lines.

**[P29] Controlling Long-Horizon Behavior in Language Model Agents with Explicit State Dynamics**
Subaharan, S. (2026). _arXiv:2601.16087_.

Maintains an explicit external VAD state governed by first-order (exponential smoothing) and second-order (momentum) update rules, fed back into generation without touching model weights; evaluated over a fixed 25-turn dialogue protocol, showing a stability-vs-responsiveness trade-off. Structurally parallel to AFT Layers 2–3 (`MoodField` EMA, `AffectiveMomentum`), but with a fixed memoryless affect estimator instead of appraisal-based encoding, and no memory store or retrieval pipeline.
...
**[P30] FadeMem: Biologically-Inspired Forgetting for Efficient Agent Memory**
Wei, L., Peng, X., Dong, X., Xie, N., Wang, B. (2026). _arXiv:2601.18642_.
...
**[P31] "My agent understands me better": Integrating Dynamic Human-like Memory Recall and Consolidation in LLM-Based Agents**
(2024). _arXiv:2404.00573_.
...
**[P32] Human-Like Remembering and Forgetting in LLM Agents: An ACT-R-Inspired Memory Architecture**
(2025). _ACM HAI 2025 / dl.acm.org/doi/10.1145/3765766.3765803_.
...
**[P33] In Prospect and Retrospect: Reflective Memory Management for Long-term Personalized Dialogue Agents**
Tan, Z., Yan, J., Hsu, I.-H., Han, R., Wang, Z., Le, L.T., Song, Y., Chen, Y. et al. (2025). _arXiv:2503.08026_.
...
| Inoshita et al.       | 2026 | LLMs Capture Emotion Labels, Not Uncertainty | arXiv:2604.27345             | N/A                                   | Zero-shot VAD distributional analysis | No                        | No          | Zero-shot VAD baseline ranges that direct-VAD (Addendum V) exceeds           |
| Tak, Gratch & Scherer | 2025 | Aware Yet Biased                             | IEEE TAFFC                   | N/A                                   | Appraisal-bias evaluation             | No                        | No          | Independently explains Addendum S valence bias and weak SEC power projection |
| Fang et al.           | 2025 | The Personalization Trap                     | arXiv:2510.09905             | User memory profiles                  | Emotional-reasoning shift analysis    | No                        | No          | Demographic-bias caution for affect-aware memory systems                     |
| Subaharan             | 2026 | Explicit State Dynamics                      | arXiv:2601.16087             | None (state only)                     | VAD EMA + momentum dynamics           | No                        | No          | Parallels AFT Layers 2–3; no appraisal, no memory store, no retrieval        |
...
3. **APE-gated reconsolidation**: No published LLM memory system implements prediction-error-gated reconsolidation windows (Nader 2000; Pearce-Hall 1980). FadeMem [P30] and DAM-LLM [P15] update memories dynamically but without a biologically motivated trigger. The ACT-R system [P32] uses activation thresholds, not prediction error.
...
_Generated: 2026-04-17; updated 2026-07-02 (P26–P29 added, later entries renumbered). Sources include arXiv, ACL Anthology, AAAI proceedings, PLOS One, ACM DL, IEEE Xplore, and Hugging Face Paper Search._
