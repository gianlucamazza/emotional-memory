...
- [Addendum L — Query-Type Routing](../../benchmarks/preregistration_addendum_l_query_routing_closure.md) — Closed-loop heuristic routing on LoCoMo: Hl1 Branch B FAIL (smoke test, 2026-05-19)
