...
|---|---:|---:|---:|---:|---:|---:|
| `aft` | 20 | 0.60 [0.40, 0.80] | 0.65 [0.45, 0.85] | 6 | 1.00 [1.00, 1.00] | 0.95 |
| `naive_cosine` | 20 | 0.55 [0.35, 0.75] | 0.55 [0.35, 0.75] | 6 | 1.00 [1.00, 1.00] | 0.00 |
...
| `recency_confound` | 2 | 0.50 [0.00, 1.00] | 0.50 [0.00, 1.00] | 6 | 1.00 [1.00, 1.00] |
| `same_topic_distractor` | 6 | 1.00 [1.00, 1.00] | 1.00 [1.00, 1.00] | 6 | 1.00 [1.00, 1.00] |
| `semantic_confound` | 8 | 0.12 [0.00, 0.38] | 0.25 [0.00, 0.62] | 6 | 1.00 [1.00, 1.00] |

### `naive_cosine`

| Challenge Type | Queries | top1 [95% CI] | hit@k [95% CI] | Min candidates | Non-trivial queries [95% CI] |
|---|---:|---:|---:|---:|---:|
| `affective_arc` | 4 | 0.75 [0.25, 1.00] | 0.75 [0.25, 1.00] | 6 | 1.00 [1.00, 1.00] |
| `recency_confound` | 2 | 0.50 [0.00, 1.00] | 0.50 [0.00, 1.00] | 6 | 1.00 [1.00, 1.00] |
| `same_topic_distractor` | 6 | 0.83 [0.50, 1.00] | 0.83 [0.50, 1.00] | 6 | 1.00 [1.00, 1.00] |
| `semantic_confound` | 8 | 0.25 [0.00, 0.62] | 0.25 [0.00, 0.62] | 6 | 1.00 [1.00, 1.00] |
...
|---|---|---:|---:|---:|---:|---:|
| `aft` | top1 | 0.05 [-0.10, 0.20] | 0.7495 | 1.0000 | 20 | 3 |
| `aft` | hit@k | 0.10 [0.00, 0.25] | 0.2585 | 0.5000 | 20 | 2 |
| `recency` | top1 | -0.55 [-0.75, -0.35] | 0.0000 | 0.0010 | 20 | 11 |
| `recency` | hit@k | -0.55 [-0.75, -0.35] | 0.0000 | 0.0010 | 20 | 11 |

## T1.3 Note

The `semantic_confound` subset above (AFT top1 = 0.12 vs naive = 0.25) was generated
with the hash embedder and is superseded by the sbert-bge run in `results.sbert.md`.
With `BAAI/bge-small-en-v1.5` the regression disappears: AFT top1 = naive top1 = 0.62;
AFT wins hit@k 0.88 vs 0.62. See the T1.3 Resolution section in `results.sbert.md`
for the full per-challenge pairwise table (computed from `challenge_subset_pairwise.json`).
