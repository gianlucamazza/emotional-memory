...
- [ ] DOI for software artifact correct: `10.5281/zenodo.19636356`
- [ ] PyPI version pinned: `emotional-memory==0.5.2`
...
| Comments | 10 pages, 4 figures, 3 tables. Software: emotional-memory v0.5.2 |
| License | CC BY 4.0 (recommended) |
| DOI | 10.5281/zenodo.19636356 (Zenodo software record) |
