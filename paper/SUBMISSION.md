...
- [ ] DOI for software artifact correct: `10.5281/zenodo.21235738`
- [ ] PyPI version pinned: `emotional-memory==0.16.0`
...
| Comments | 19 pages, 4 figures, 3 tables. Software: emotional-memory v0.16.0 |
| License | CC BY 4.0 (recommended) |
| DOI | 10.5281/zenodo.21235738 (Zenodo software record for v0.16.0) |
