...
- [ ] DOI for software artifact correct: `10.5281/zenodo.21402228`
- [ ] PyPI version pinned: `emotional-memory==0.17.0`
...
| Comments | 19 pages, 4 figures, 3 tables. Software: emotional-memory v0.17.0 |
| License | CC BY 4.0 (recommended) |
| DOI | 10.5281/zenodo.21402228 (Zenodo software record for v0.17.0) |
