...
- [ ] DOI for software artifact correct: `10.5281/zenodo.19686077` (or replace with the new version DOI after Zenodo publish)
- [ ] PyPI version pinned: `emotional-memory==0.6.2`
...
| Comments | 10 pages, 4 figures, 3 tables. Software: emotional-memory v0.6.2 |
| License | CC BY 4.0 (recommended) |
| DOI | 10.5281/zenodo.19686077 (Zenodo concept DOI; replace with the new version DOI after publish if available) |
