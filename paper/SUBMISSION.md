...
- [ ] DOI for software artifact correct: `10.5281/zenodo.20070143`
- [ ] PyPI version pinned: `emotional-memory==0.10.0`
...
| Comments | 10 pages, 4 figures, 3 tables. Software: emotional-memory v0.10.0 |
| License | CC BY 4.0 (recommended) |
| DOI | 10.5281/zenodo.20070143 (Zenodo software record for v0.10.0) |
