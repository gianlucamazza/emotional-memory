...
- [ ] PyPI version pinned: `emotional-memory==0.8.2`
...
| Comments | 10 pages, 4 figures, 3 tables. Software: emotional-memory v0.8.2 |
| License | CC BY 4.0 (recommended) |
| DOI | 10.5281/zenodo.20025559 (Zenodo software record for v0.8.2) |
