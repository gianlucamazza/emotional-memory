...
naturalistic dialogue ($\Delta=-0.008$) and \emph{negative} on a third-party
emotion-support corpus whose gold recall is counter-congruent
($\Delta=-0.083$). The ranking edge converts end-to-end
...
(Addenda A--X, plus the Hd2 power top-up) since initial submission. The expanded realistic-recall benchmark ($N=200$, five
...
to the affect-discriminative regime (Addendum~T2A, $\Delta=-0.008$), and the first
third-party test (Addendum~X, MADial-Bench) is significantly negative
($\Delta=-0.083$): the benchmark rewards counter-congruent supportive recall, exposing a
construct boundary between mood-congruent and emotion-regulatory retrieval. Per-category
...
the authors of EmoBank, DailyDialog, LoCoMo, and MADial-Bench for releasing the
