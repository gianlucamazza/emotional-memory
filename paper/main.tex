...
hit@k advantage ($\Delta=+0.15$, $p=0.0005$) but lower absolute accuracy,
consistent with the English-centric SBERT embedder.
Any claim about AFT's retrieval advantage should therefore be scoped to
\emph{English conversational text with dense embeddings}.
