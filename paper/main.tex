...
significance. A multilingual Italian slice (G6, $N=80$) shows a significant
hit@k advantage under both embedder families tested: $\Delta=+0.15$ ($p=0.0005$)
with English-centric SBERT bge-small-en-v1.5, and $\Delta=+0.16$ ($p=0.001$)
with multilingual-e5-small (intfloat, 117M parameters, 100+ languages).
