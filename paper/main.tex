...
Cross-language evidence is therefore limited to a single exploratory Spanish-SBERT
result at $N=80$; the \texttt{multilingual-e5-small} runs at the pre-declared power
do not establish the effect for Italian or Spanish.
...
Cross-language evidence is therefore limited to a single exploratory positive
(Spanish-SBERT, $N=80$); broader language coverage requires explicit replication.
