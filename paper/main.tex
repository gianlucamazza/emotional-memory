...
third-party corpora ($\Delta=-0.083$, $-0.164$). The ranking edge converts end-to-end
...
(nDCG@4 $0.284$ vs $0.120$, $\Delta=-0.164$ [$-0.179$, $-0.149$], $d=-0.653$; MDE $0.019$),
with faithful appraisal (AUC $=0.971$) and---contrary to the pre-registered low-D2
prior---an affect-discriminative corpus ($68.2\%$). The post-hoc failure mode is
...
$\Delta=-0.164$; affect-orthogonal QA gold)---so positive retrieval evidence remains
