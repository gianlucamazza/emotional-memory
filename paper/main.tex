...
\newcommand{\zenodoversiondoi}{10.5281/zenodo.20025559}% [ssot:version_doi]
...
(deferred; see \texttt{benchmarks/preregistration\_addendum\_a\_closure.md})
...
Integration with vector stores (Qdrant, Chroma) and expanded baselines
(Mem0, MemGPT) are engineering milestones independent of the evidence programme.
